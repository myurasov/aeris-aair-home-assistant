...
- **Build documentation:** source-build instructions pinned to Device OS 3.3.1 and sensor-protocol research links in the [README](README.md).

### Fixed

- **PM decoding:** mass fields use zero-based offsets 4/6/8 in 32-byte `32 3D` frames. Earlier PM2.5/PM10 decoding incorrectly used particle-count offsets 12/14.
...
- Build for Particle Photon using Device OS 3.3.1.
